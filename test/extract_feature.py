...
def load_model(name, checkpoint_file, GeM_p):
    ...
    if name == "vit_small" or name == "vit_base" or name == "vit_small_pattern" or name == "vit_base_pattern"  or name == "vit_large_pattern" or name == "vit_small_pattern_tune" or name == "vit_base_pattern_tune" or \
       name == "vit_tiny_pattern" or name == "vit_tiny_pattern_tune" or name == "vit_large_pattern_tune":
        import models
...
def main():
    ...
    aa('--batch_size', default=100, type=int, help="max batch size to use for extraction")
