...
import dg.models_gem_waveblock_balance_cos.vit_models_tune

__all__ = ['VisionTransformer','vit_tiny_pattern_tune', 'vit_small_pattern_tune', 'vit_base_pattern_tune', 'vit_large_pattern_tune', 'vit_huge_pattern_tune']
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, weight, pretrained=True, cut_at_pooling=False,
        ...
        elif self.weight == 'huge_pattern_tune':
            vit = create_model(
                'deit_huge_pattern_patch16_224_tune',
                pretrained=True,
                num_classes=1_000,
                drop_rate=0,
                drop_path_rate=0.1,
...
def vit_huge_pattern_tune(**kwargs):
    return VisionTransformer('huge_pattern_tune', **kwargs)