...
__all__ = ['VisionTransformer', 'vit_tiny', 'vit_small', 'vit_base','vit_tiny_pattern', 'vit_small_pattern', 'vit_base_pattern', 'vit_large_pattern', 'vit_huge_pattern']
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, weight, pretrained=True, cut_at_pooling=False,
        ...
        elif self.weight == 'huge_pattern':
            vit = create_model(
                'deit_huge_pattern_patch16_224',
                pretrained=True,
                num_classes=1_000,
                drop_rate=0,
                drop_path_rate=0.1,
...
def vit_huge_pattern(**kwargs):
    return VisionTransformer('huge_pattern', **kwargs)