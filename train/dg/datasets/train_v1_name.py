...
class Train_v1_name(object):

    def __init__(self, root, combine_all=True):
        
        self.images_dir = '' 
        self.img_path = osp.join(root) + '/train_v1_name'
        ...
        self.labels = np.load('train_v1_labels_num.npy', allow_pickle=True).tolist()
        self.load()
    ...
    def preprocess(self):
        ...
        for fpath in fpaths:
            ...
            try:
                target_pattern = torch.zeros([11], dtype=torch.float32)
